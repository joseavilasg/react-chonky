...
const useStyles = makeLocalChonkyStyles((theme, { entryState, dndState }) => ({
  listFileEntry: {
    ...
    color: dndState.dndIsOver ? (dndState.dndCanDrop ? theme.dnd.canDropColor : theme.dnd.cannotDropColor) : 'inherit',
    alignItems: 'center',
    position: 'relative',
    display: 'flex',
    height: '100%',
  ...
  listFileEntryIcon: {
    color: dndState.dndIsOver ? (dndState.dndCanDrop ? theme.dnd.canDropColor : theme.dnd.cannotDropColor)
      : entryState.color,
