...
import { ChonkyBusinessLogic } from "@/components/internal/ChonkyBusinessLogic";
import { ChonkyIconPlaceholder } from "@/components/internal/ChonkyIconPlaceholder";
import { ChonkyPresentationLayer } from "@/components/internal/ChonkyPresentationLayer";
import {
...
export const ChonkywithStore: FC<{
  children: ReactNode;
  instanceId?: string;
}> = ({ children, instanceId }) => {
  const chonkyInstanceId = useStaticValue(
